...
public class Tehokkuus {
    ...
    private static void testi1() {
        try (
            ...
            System.out.printf("%nAikaa inserttiin meni ilman indeksiä: " +inserttiSekunneissa +" sekuntia%n");
            System.out.printf("Aikaa hakuun meni ilman indeksiä: " +hakuSekunneissa +" sekuntia%n");
    ...
    private static void testi2() {
        try (
            Connection db2 = DriverManager.getConnection("jdbc:sqlite:testi2.db");
            ...
            System.out.printf("Aikaa inserttiin meni " +inserttiSekunneissa2 +" sekuntia kun indeksi lisättiin ennen rivien lisäämistä%n");
            System.out.printf("Aikaa hakuun meni " +hakuSekunneissa2 +" sekuntia kun indeksi lisättiin ennen rivien lisäämistä%n");
    ...
    private static void testi3()  {
        try (
            Connection db3 = DriverManager.getConnection("jdbc:sqlite:testi3.db");
            ...
            System.out.printf("Aikaa inserttiin meni " +inserttiSekunneissa3 +" sekuntia kun indeksi lisättiin rivien lisäämisen jälkeen%n");
            System.out.printf("Aikaa hakuun meni " +hakuSekunneissa3 +" sekuntia kun indeksi lisättiin rivien lisäämisen jälkeen%n");
